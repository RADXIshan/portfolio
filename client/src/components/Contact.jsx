...
const Contact = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col h-[40vh] md:flex-row items-center justify-center gap-12 w-full max-w-6xl">
        ...
        <div className="w-full md:w-1/2 h-full flex flex-col items-center justify-center p-8 rounded-xl backdrop-blur-md transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(0,0,0,0.6),0_0_25px_rgba(255,255,255,0.05)_inset]">
          <form
            onSubmit={handleSubmit}
            className="w-full max-w-md flex flex-col gap-5"
          >
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#FAF9F6] mb-1">
                Name
              </label>
              <input
                type="text"
                ...
                required
                className="w-full p-3 border border-[rgba(255,255,255,0.1)] rounded-lg bg-[rgba(255,255,255,0.02)] text-[#FAF9F6] text-base outline-none transition duration-300 focus:border-[rgba(255,255,255,0.25)] focus:bg-[rgba(255,255,255,0.06)] focus:ring-1 focus:ring-white/20"
              />
            </div>

            <div>
              <label htmlFor="email" className="block text-sm font-medium text-[#FAF9F6] mb-1">
                Email
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-[#FAF9F6] mb-1">
                Message
              </label>
              <textarea
                id="message"
